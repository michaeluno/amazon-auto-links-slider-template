...
$sClassAttributes_ProductsContainer = 'amazon-products-slider-container' . ' amazon-unit-' . $aArguments[ 'id' ];
...
// $_sElementWidth = amazon-product-slider-element
// var_dump( $aArguments );
...
<div class="<?php echo $sClassAttributes_ProductsContainer; ?>" style="<?php echo $_sInlineStyle; ?>">
    <ul class="amazon-products-slider">
    <?php foreach( $aProducts as $_aProduct ) : ?>
        <?php $_aProduct = $_aProduct + $_aStructure_Product; ?>
        <li class="amazon-product-slider-element" style="<?php echo $_sSliderElementInlineCSS; ?>">
